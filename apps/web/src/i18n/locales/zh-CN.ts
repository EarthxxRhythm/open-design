...
export const zhCN: Dict = {
  ...
  'chat.runError.title.buildRoundSessionLost': "建造轮的会话丢了",
  'chat.runError.title.roundInterrupted': "这一轮被中断了",
  'chat.runError.title.roundSettlementFailed': "这一轮没能记录下来",
  'chat.runError.title.taskRecordMismatch': "任务记录对不上",
  'chat.runError.title.attachmentsTooLarge': "附件太大",
  'chat.runError.title.attachmentsChanged': "附件变了",
  ...
  'chat.runError.buildRoundSessionLostMessage': "建造轮本来要接着规划轮的 agent 会话继续，但开始时那个会话已经不在了。再发一次请求就会在这个对话里新起一轮：规划内容留在对话记录里，已经写好的文件留在项目里。",
  'chat.runError.roundInterruptedMessage': "agent 在这一轮结束前停了下来。再发一次请求就会在这个对话里新起一轮；已经写好的文件留在项目里。",
  'chat.runError.roundSettlementFailedMessage': "agent 已经跑完，但 Open Design 在记录这一轮、准备下一轮时出了错。再发一次请求就会新起一轮；反复出现的话，导出日志发给我们。",
  'chat.runError.taskRecordMismatchMessage': "Open Design 里这个任务的记录和正要启动的运行对不上，这一轮在 agent 启动前就停了。再发一次请求就会用新的记录重新起一轮。",
  'chat.runError.attachmentsTooLargeMessage': "附件超出了一次请求能带的上限。去掉或压缩一部分，再发一次。",
  'chat.runError.attachmentsChangedMessage': "准备请求时附件发生了变化，或冻结下来的副本对不上，没能交给 agent。再发一次即可。",
  ...
  "designFiles.entryMissingTitle": "没有可预览的入口。",
  "designFiles.entryMissingBody": "这一轮写了 {n} 个文件，但没有一个能作为入口打开：",
  "designFiles.entryMissingMore": "还有 {n} 个",
  "designFiles.entryMissingAsk": "让 agent 补一个入口",
  "designFiles.entryMissingHint": "也可以打开某个文件的菜单，选择“设为入口”。",
  "designFiles.setAsEntry": "设为入口",
  "designFiles.entryBadge": "入口",
  "designFiles.entryRequestMessage": "项目里没有能作为入口打开的文件。请补一个入口（根目录的 index.html，链接到已经做好的页面，或者把现有的主页面改成这个名字），让预览能打开。",
