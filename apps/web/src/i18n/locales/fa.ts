...
export const fa: Dict = {
  ...
  'chat.runError.title.buildRoundSessionLost': "دور ساخت نشست خود را از دست داد",
  'chat.runError.title.roundInterrupted': "دور قطع شد",
  'chat.runError.title.roundSettlementFailed': "ثبت دور ممکن نشد",
  'chat.runError.title.taskRecordMismatch': "رکورد وظیفه مطابقت ندارد",
  'chat.runError.title.attachmentsTooLarge': "پیوست‌ها خیلی بزرگ‌اند",
  'chat.runError.title.attachmentsChanged': "پیوست‌ها تغییر کرده‌اند",
  ...
  'chat.runError.buildRoundSessionLostMessage': "دور ساخت قرار بود نشست عامل از دور برنامه‌ریزی را ادامه دهد، اما هنگام شروع آن نشست دیگر وجود نداشت. درخواست را دوباره بفرستید تا دور تازه‌ای در همین گفتگو آغاز شود: برنامه در تاریخچه می‌ماند و فایل‌هایی که پیش‌تر نوشته شده‌اند در پروژه می‌مانند.",
  'chat.runError.roundInterruptedMessage': "عامل پیش از پایان این دور متوقف شد. درخواست را دوباره بفرستید تا دور تازه‌ای در همین گفتگو آغاز شود؛ فایل‌هایی که پیش‌تر نوشته شده‌اند در پروژه می‌مانند.",
  'chat.runError.roundSettlementFailedMessage': "عامل کارش را تمام کرد، اما Open Design هنگام ثبت این دور و شروع دور بعدی به خطا خورد. درخواست را دوباره بفرستید تا دور تازه‌ای آغاز شود؛ اگر تکرار شد، گزارش‌ها را صادر کنید و برای ما بفرستید.",
  'chat.runError.taskRecordMismatchMessage': "رکوردی که Open Design از این وظیفه دارد با اجرایی که در حال شروع بود مطابقت نداشت، بنابراین دور پیش از راه‌اندازی عامل متوقف شد. درخواست را دوباره بفرستید تا دور تازه‌ای با رکوردهای جدید آغاز شود.",
  'chat.runError.attachmentsTooLargeMessage': "پیوست‌ها از حدی که یک درخواست می‌تواند حمل کند فراتر رفته‌اند. برخی را حذف یا کوچک کنید و درخواست را دوباره بفرستید.",
  'chat.runError.attachmentsChangedMessage': "پیوست‌ها هنگام آماده‌سازی درخواست تغییر کردند یا نسخهٔ ثابت‌شدهٔ آن‌ها مطابقت نداشت، بنابراین به عامل تحویل داده نشدند. درخواست را دوباره بفرستید.",
  ...
  'designFiles.entryMissingTitle': 'فایل ورودی برای پیش‌نمایش وجود ندارد.',
  'designFiles.entryMissingBody': 'این دور {n} فایل نوشت، اما هیچ‌کدام به‌عنوان ورودی باز نمی‌شود:',
  'designFiles.entryMissingMore': 'و {n} مورد دیگر',
  'designFiles.entryMissingAsk': 'از ایجنت بخواهید ورودی اضافه کند',
  'designFiles.entryMissingHint': 'یا منوی فایل را باز کنید و «تنظیم به‌عنوان ورودی» را انتخاب کنید.',
  'designFiles.setAsEntry': 'تنظیم به‌عنوان ورودی',
  'designFiles.entryBadge': 'ورودی',
  'designFiles.entryRequestMessage': 'هیچ فایلی در این پروژه به‌عنوان صفحهٔ ورودی باز نمی‌شود. یک ورودی اضافه کنید (یک index.html در ریشه که به صفحه‌های ساخته‌شده پیوند دهد، یا صفحهٔ اصلی موجود را به این نام تغییر دهید) تا پیش‌نمایش بتواند آن را باز کند.',
